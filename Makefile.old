...
MAKEMAKER   = /usr/local/share/perl/5.28.1/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.44
MM_REVISION = 74400
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/FRDCSA/PlanMonitor.pm
...
manifypods : pure_all config  \
	lib/FRDCSA/PlanMonitor.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3SECTION) --perm_rw=$(PERM_RW) -u \
	  lib/FRDCSA/PlanMonitor.pm $(INST_MAN3DIR)/FRDCSA::PlanMonitor.$(MAN3EXT) 
